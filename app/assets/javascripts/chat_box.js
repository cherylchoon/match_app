...
var ready = function () {
    ...
    chatBox = {
        ...
        chatWith: function (chat_id) {
            ...
            console.log("called, inside chatWith function")
        ...
        /**
         * Plays a notification sound when a new chat chat_message arrives
         */
        ...
        checkInputKey: function (event, chatboxtextarea, chat_id) {
            if (event.keyCode == 13 && event.shiftKey == 0) {
                ...
                chat_message = chatboxtextarea.val();
                chat_message = chat_message.replace(/^\s+|\s+$/g, "");
